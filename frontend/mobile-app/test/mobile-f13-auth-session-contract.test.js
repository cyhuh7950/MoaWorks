...
function createState() {
  return {
    ...
    businessSearchQuery: "stale-business-search",
    businessSearchSelectedResultId: "stale-search-result",
    businessSearchWarnings: ["메일"],
    actionReason: "stale-reason",
    personalAiProviders: [{ provider: "groq", label: "Groq", apiKeyRequired: true }],
    llmProvider: "groq",
    llmModel: "stale-model",
    llmModels: ["stale-model"],
...
function clearedState(message) {
  return {
    ...
    directoryBusyUserId: "",
    businessSearchQuery: "",
    businessSearchSelectedResultId: "",
    businessSearchWarnings: [],
    actionReason: "확인",
    personalAiProviders: [],
    llmProvider: "openai",
    llmModel: "",
