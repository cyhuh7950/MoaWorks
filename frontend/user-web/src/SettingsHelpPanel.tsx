...
export function SettingsHelpPanel({ mode, token, onPreferencesSaved, onOpenWorkspaceSettings }: Props) {
  ...
  return <section className="ui044-settings-help" aria-busy={loading}>
    ...
    <main className="ui044-settings-help__detail">{notice ? <div role="status" className="ui044-settings-help__notice">{notice}</div> : null}{settingsDetail}</main>
