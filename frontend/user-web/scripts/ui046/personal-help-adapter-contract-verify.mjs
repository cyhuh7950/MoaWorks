...
], profile: { matchesPreparedIdentity: true, readOnly: true, fieldCount: 5 }, general: { locale: "ko-KR", timezone: "Asia/Tokyo", startPage: "files", version: 1, rereadMatches: true }, notifications: { enabled: true, quietHoursEnabled: true, quietHoursStart: "21:30", quietHoursEnd: "06:30", mail: { enabled: true, importantOnly: true }, rereadMatches: true }, security: { clientMismatchRequestCount: 0, changeRequestCount: 1, reloginWithNewCredential: true, sensitiveEvidenceFields: 0 }, modules: { visible: ["mail", "approval", "calendar"], foreignNavigationCount: 0 }, help: { allCount: 6, errorSearchCount: 4, errorCategoryCount: 4, emptyCount: 0, selectedDocumentVisible: true, mutationCount: 0, searchEvidencePersisted: false }, visual: { viewport: "1920x1080", bodyPx: 12, screenTitlePx: 16, sectionTitlePx: 14, helperPx: 10, infoTooltip: true }, network: networkFixture(), mutationOwnership: [
